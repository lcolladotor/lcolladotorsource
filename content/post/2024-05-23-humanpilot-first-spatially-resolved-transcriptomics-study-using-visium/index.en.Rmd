...
[![Orange (full round)](images/orange.jpg){width="400px"}](https://en.wikipedia.org/wiki/File:Oranges_-_whole-halved-segment.jpg)

[![Bananas in the supermarket](images/Bananas.jpg){width="400px"}](https://en.wikipedia.org/wiki/File:Bananas.jpg)
...
[![Orange (sliced with a knife)](images/orange_sliced.jpg){width="400px"}](https://en.wikipedia.org/wiki/File:Oranges_-_whole-halved-segment.jpg)

[![Banana sliced](images/Banana-slice-isolated-on-transparent-background-PNG.png){width="400px"}](https://similarpng.com/banana-slice-isolated-on-transparent-background-png/)
...
[![Nature Methods 2020 cover](images/nat_methods_spatial.png){width="400px"}](https://doi.org/10.1038/s41592-020-01042-x)
...
[![3D barplots](images/Color3DBarsByHeightExample_02.png){width="400px"}](https://www.mathworks.com/help/matlab/creating_plots/color-3-d-bars-by-height-1.html)
...
[![Figure 1 A and B from the HumanPilot study](images/fig1ab.png){width="800px"}](https://doi.org/10.1038/s41593-020-00787-0)
...
[![Figure 1 D, E, and F from the HumanPilot study](images/fig1def.png){width="800px"}](https://doi.org/10.1038/s41593-020-00787-0)
...
Now that trusted the technology, we could get to work. We started visualizing gene activity patterns for genes that other scientists had previously identified as marker genes for the DLPFC layers. Some have identified in other organisms such as mouse. Some, due to the nature of _Visium_, we can only measure 2,000 genes instead of 20,000-30,000 ones that you can detect with other non-spatially-aware technologies.
...
[![Figure 4 from the HumanPilot study](images/fig4.png){width="800px"}](https://doi.org/10.1038/s41593-020-00787-0)
...
`r blogdown::shortcode("tweet", user="helucro", id="1597579271945715717")`
