...
`r blogdown::shortcode("tweet", user="WeAreRLadies", id="1055124381876260865")`
...
`r blogdown::shortcode("tweet", user="mreyespri", id="1060116424415436800")`

`r blogdown::shortcode("tweet", user="paleogenomics", id="1060355174546505729")`
