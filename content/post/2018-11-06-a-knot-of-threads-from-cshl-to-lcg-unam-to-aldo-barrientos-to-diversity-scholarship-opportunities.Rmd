...
`r blogdown::shortcode("tweet", user="mgschiavon", id="")`

`r blogdown::shortcode("tweet", user="WeAreRLadies", id="")`

`r blogdown::shortcode("tweet", user="daniela_oaks", id="")`
...
`r blogdown::shortcode("tweet", user="lbolanos68", id="")`

`r blogdown::shortcode("tweet", user="mreyespri", id="")`
