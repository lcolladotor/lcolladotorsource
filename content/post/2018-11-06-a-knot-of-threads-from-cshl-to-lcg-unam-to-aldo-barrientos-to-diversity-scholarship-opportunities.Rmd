...
`r blogdown::shortcode("tweet", "1052349309818232832")`

To close off, here are some inspiring or thought provoking tweets:

`r blogdown::shortcode("tweet", "1056571008662949888")`

`r blogdown::shortcode("tweet", "1055124381876260865")`

`r blogdown::shortcode("tweet", "1019597807395770368")`

`r blogdown::shortcode("tweet", "1001985730904764417")`
...
`r blogdown::shortcode("tweet", "1060038817774657536")`

`r blogdown::shortcode("tweet", "1060116424415436800")`

`r blogdown::shortcode("tweet", "1060355174546505729")`
