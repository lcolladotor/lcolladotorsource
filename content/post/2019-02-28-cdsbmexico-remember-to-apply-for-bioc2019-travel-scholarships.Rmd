...
_This blog post was first published at the [CDSBMexico website](http://www.comunidadbioinfo.org/cdsbmexico-remember-to-apply-for-bioc2019-travel-scholarships/)._
...
```{r bibliography, results = 'asis', echo = FALSE, warnincache g = FALSE, = FALSE, warnrint bibliography
